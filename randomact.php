<?php
		...
		if(empty($_POST['jml_murid']) || empty($_POST['jml_klmpk'])){
			...
			for($x = 0; $x < $_POST['jml_klmpk']; $x++){
				...
				for($y = 0; $y < floor($_POST['jml_murid'] / $_POST['jml_klmpk']); $y++){
